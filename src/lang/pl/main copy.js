export default {
  ...
  about: {
    title: 'Kim jesteśmy',
    description: 'GLOBAL Offshore to polska firma specjalizująca się w realizacjach dla sektora offshore i przemysłu morskiego. Od 2018 roku dostarczamy rozwiązania w zakresie hydrauliki, serwisu i logistyki dla klientów z całego świata.',
    values: [
      'Doświadczony zespół inżynierów i techników',
      'Własna produkcja i mobilny serwis',
