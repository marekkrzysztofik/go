    ...
    <div>
        ...
        <section class="hero">
            ...
            <div class="hero-content">
                <h1 class="hero-title">{{ langState.t.main.heroTitle }}</h1>
                <p class="hero-subtitle">{{ langState.t.main.heroSubtitle }}</p>
                <RouterLink to="/zgloszenie" class="hero-button">
                    {{ langState.t.main.heroButton }}
                </RouterLink>
            </div>
        </section>
